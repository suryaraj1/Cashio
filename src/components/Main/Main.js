        ...
        return (
            <div className='main-content-wrapper'>
                <div className='main-input-wrapper'>
                    <InputComponent inputTitle="Bill Amount" callbackHandler={this.billAmountHandler}/>
                    <InputComponent inputTitle="Cash Given" callbackHandler={this.cashAmountHandler} />
                </div>
